 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8733/Design_Time_Addresses/Week5Service/UserService/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://tempuri.org/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8733/Design_Time_Addresses/Week5Service/UserService/?wsdl");
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IUserService")
    public IUserService getBasicHttpBindingIUserService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IUserService"), IUserService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IUserService")
    public IUserService getBasicHttpBindingIUserService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IUserService"), IUserService.class, features);
    }
